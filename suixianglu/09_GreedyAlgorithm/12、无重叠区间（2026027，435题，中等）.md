...
<table>
  <tr>
    <td bgcolor="Yellow" style="padding: 5px; border: 0px solid black;">
      <span style="font-weight: bold; font-size: 20px;">自己调试版本（按照左边界从小到大排序，lambda表达式中参数改为引用）</span>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td bgcolor="Yellow" style="padding: 5px; border: 0px solid black;">
      <span style="font-weight: bold; font-size: 20px;">自己调试版本（按照左边界从小到大排序，通过！！！）</span>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td bgcolor="Yellow" style="padding: 5px; border: 0px solid black;">
      <span style="font-weight: bold; font-size: 20px;">仿照答案版本v3（按照左边界从小到大排序）</span>
    </td>
  </tr>
</table>
...
```
![alt text](17f272abfb9328494d7a1cae5d36e76.png)


<table>
  <tr>
    <td bgcolor="Yellow" style="padding: 5px; border: 0px solid black;">
      <span style="font-weight: bold; font-size: 20px;">随想录答案（按照左边界从小到大排序）</span>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td bgcolor="Yellow" style="padding: 5px; border: 0px solid black;">
      <span style="font-weight: bold; font-size: 20px;">仿照答案版本v2（去注释,按照右边界从小到大排序）</span>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td bgcolor="Yellow" style="padding: 5px; border: 0px solid black;">
      <span style="font-weight: bold; font-size: 20px;">仿照答案版本v2（按照右边界从小到大排序）</span>
    </td>
  </tr>
</table>
